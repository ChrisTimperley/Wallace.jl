...
project = u'Wallace'
copyright = u'2015, Christopher Steven Timperley'
...
exclude_patterns = ['_build', '_template']
...
latex_documents = [
  ('index', 'wallace.tex', u'Wallace.jl Documentation',
   u'Christopher Steven Timperley', 'manual'),
]
